...
class jetTurnOn(supy.analysis) :
    ...
    def listOfSteps(self,config) :
        ...
        outList=[
            ...
            steps.histos.turnOnJet(jetColl=refJetColl, trigger='EmulatedL2FSPS_6j50', nTh=5, emulated=True),
            steps.histos.turnOnJet(jetColl=refJetColl, trigger='EmulatedL2FSPS_6j55', nTh=5, emulated=True),
